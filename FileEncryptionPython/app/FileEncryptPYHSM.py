...
HSM_Lib = os.environ.get('HSM_SO_FILE')
# Function to encrypt a file using AES-CBC mode with PKCS7 padding
def encrypt_file(SlotID, SlotPIN, file_path, aes_key_label, init_vector):
    try:
...
def decrypt_file(SlotID, SlotPIN, encrypted_file_path, aes_key_label, init_vector):
    try:
